...
const Platform = ({drivingInfo}) => {
  ...
  return (
    <div className="w-full">
      ...
      <Feature text="Viajes por hora" value={trips_hour} isMoney={false} units=" trips"/>
      <Feature text="Horas al día" value={hours_day} isMoney={false} units="hrs"/>
      <Feature text="Dias trabajados por semana" value={days_per_week} isMoney={false} units=" days"/>
